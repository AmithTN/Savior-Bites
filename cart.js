...
function addToCart(category) {
 ...
 //   console.log('Current cartData:', cartData); // Log current cart data
    ...
    inputs.forEach(input => {
        ...
        if (quantity > 0) {
            ...
            if (existingProduct) {
                ...
                cartData.push({ product: productName, price: price, quantity: quantity });
            }
        }
    });
    
    localStorage.setItem('cartData', JSON.stringify(cartData));
   // alert("Items added to cart!");    //--> commented
    displayCartItems();
}
